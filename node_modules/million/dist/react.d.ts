...
declare const unstable_batchedUpdates: (_callback: () => any) => (flush: boolean) => boolean;

declare const COMPONENT_FIELD = "__m_component";
...
declare const _default: {
    ...
    unstable_batchedUpdates: (_callback: () => any) => (flush: boolean) => boolean;
    ...
    cloneElement: (vnode: VNode | [VElement], config?: VProps | undefined) => VNode | VNode[];
    ...
    isValidElement: (vnode?: VNode | VNode[] | null | undefined) => boolean;
...
export { COMPONENT_FIELD, compat, createClass, createComponent, createPortal, createRoot, _default as default, getCircularReplacer, hydrateRoot, render, unstable_batchedUpdates, version };
