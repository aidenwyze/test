...
export { a4 as COMPONENT_FIELD, A as Fragment, L as compat, a7 as createClass, a6 as createComponent, N as createContext, q as flushSync, a5 as getCircularReplacer, M as hook, y as jsx, y as jsxDEV, y as jsxs, q as startTransition, q as unstable_startTransition, T as unstable_useDeferredValue, _ as unstable_useMutableSource, a2 as unstable_useTransition, Q as useCallback, R as useContext, S as useDebugValue, T as useDeferredValue, Y as useDelta, U as useEffect, P as useId, V as useImperativeHandle, U as useInsertionEffect, W as useLayoutEffect, Z as useList, X as useMemo, _ as useMutableSource, $ as useReducer, a0 as useRef, a1 as useState, _ as useSyncExternalStore, a2 as useTransition } from './chunks/render.mjs';

const isSingleVNode = (vnode) => {
  return Array.isArray(vnode) && vnode.length === 1 && isValidElement(vnode[0]);
};
const cloneElement = (vnode, config) => {
...
export { Children, Component, PureComponent, StrictMode, Suspense, SuspenseList, cloneElement, createElement, createPortal, createRef, createRoot, index as default, forwardRef, hydrateRoot, isValidElement, lazy, memo, render, SuspenseList as unstable_SuspenseList, unstable_batchedUpdates, version };
